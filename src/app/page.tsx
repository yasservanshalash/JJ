  ...
  return (
    <main className="bg-white">
      <header className="bg-[#212B36] h-[85vh]">
        ...
        <Image src={airbnb} width="94" height="28" alt="airbnb" style={{filter: "invert(73%) sepia(17%) saturate(273%) hue-rotate(169deg) brightness(84%) contrast(83%)"}}/>
        <Image src={dropbox} width="94" height="28" alt="dropbox" style={{filter: "invert(73%) sepia(17%) saturate(273%) hue-rotate(169deg) brightness(84%) contrast(83%)"}}/>
        <Image src={facebook} width="94" height="28" alt="facebook" style={{filter: "invert(73%) sepia(17%) saturate(273%) hue-rotate(169deg) brightness(84%) contrast(83%)"}}/>
        <Image src={google} width="94" height="28" alt="google" style={{filter: "invert(73%) sepia(17%) saturate(273%) hue-rotate(169deg) brightness(84%) contrast(83%)"}}/>
