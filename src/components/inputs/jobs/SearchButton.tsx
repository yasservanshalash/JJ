...
export default function SearchJobsButton() {
  return (
    // <Paper
    //   component="form"
  ...
  >
    {/* <IconButton className="w-[97%] lg:w-[24px] lg:h-[24px] m-auto lg:m-0 bg-[#fa541c] p-2 lg:p-6 rounded-lg lg:mr-2"> */}
    <IconButton style={{backgroundColor: "#000"}} sx={{width: { xs: "97%", lg: "24px"},height: {lg: "24px"}, margin: {xs: "0 auto", lg: "0"}, p: {xs: 2, md: 1.5, lg:3}, borderRadius: "10px", mr: {lg: 0}}}>
      <SearchIcon sx={{ color: "white" }} />
    </IconButton>
  </form>
  );
