...
const LandingHeader = () => {
  return (
    <header className="bg-[#171728] h-[140vh]">
      <div className="w-[85%] m-auto lg:m-0 py-2">
        <h1 className="text-[2.5rem] md:text-[3.25rem] text-white font-bold pt-8 text-center lg:text-left">
          Get The <span className="text-[#fa541c]">Career</span> You Deserve
        </h1>
      </div>
      <p className="text-[#919eab] text-center lg:text-left p-5">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut atque
        dolores repudiandae ullam magnam.
      </p>
      <div className="lg:flex lg:justify-start lg:items-center lg:ml-0 lg:w-[60%]">
